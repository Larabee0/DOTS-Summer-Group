...
public struct GridGenerateMesh : IComponentData { }
public struct GridGeneratingMesh : IComponentData { }
public struct GridGeneratedMesh : IComponentData { }


public struct GridMeshStore : IComponentData
{
    public Mesh.MeshDataArray Value;
}

public class GridMeshReference : IComponentData
{
    public Mesh Value;
}

public class GridMaterialReference : IComponentData
{
    public Material[] materials;
}

public struct GridSubMeshRenderers : IComponentData
{
    public Entity mesh0;
    public Entity mesh1;
    public Entity mesh2;
